      ...
      <div className="lg:relative">
        ...
        <div className="first-sec lg:relative flex lg:mx-[80px] lg:flex lg:justify-between bg-[#2A254B] text-white px-[24px] lg:px-0 pb-[32px] lg:pb-0">
          <div className="lg:relative">
            ...
            <p className="text-[18px] font-extralight mt-[97px] lg:absolute lg:bottom-16 lg:px-[60px]">A new era in eco friendly furniture with Avelon, the French luxury retail brand
