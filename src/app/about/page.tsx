      ...
      <main className="flex flex-col">
        ...
        <section className="space-y-6">
          <h2 className="text-[32px] font-light leading-10 pt-[25px] px-[24px]">
            A brand built on the love of craftmanship, quality and <br /> outstanding customer service
          </h2>
          <div className="space-y-4 text-sm text-gray-600 pt-[70px] px-[24px]">
            <h2 className="text-[20px]">From a studio in London to a global brand with over 400 outlets</h2>
            <p>When we started Avion, the idea was simple. Make high quality furniture affordable and available to the mass market.</p>
            <p>Handmade, and lovingly crafted furniture and homeware is what we live, breathe and design so our Chelsea boutique became the hotbed for the London interior design community.</p>
            <button className="w-[100%] flex justify-center items-center text-black hover:bg-[#4a4566] h-[56px] mt-[32px] px-[24px]">Get in touch</button>
          </div>
          <div className="bg-gray-100 w-[100%]">
            <Image className="w-[100%]" src="/Image.png" alt="" width={390} height={358}/>
            <Image className="w-[100%]" src="/Image1.png" alt="" width={390} height={358}/>
          </div>
        </section>
        ...
        <div className="px-[24px] space-y-6 pt-[50px] pb-[60px]">
          ...
          <div className="space-y-4 text-sm text-gray-600">
            ...
            <div className="pt-[30px]">
                <button className="w-[100%] flex justify-center items-center text-black hover:bg-[#4a4566] h-[56px] px-[24px]">Get in touch</button>
            </div>
          </div>
        </div>
        ...
        <div className="px-[24px] pt-[30px] pb-[30px] bg-[url('/Image3.png')] bg-cover bg-no-repeat	bg-center">
          <div className="space-y-4">
            <h2 className="text-2xl font-light">Join the club and get the benefits</h2>
            <p className="text-sm">Sign up for our newsletter and receive exclusive offers on new ranges, sales, pop up stores and more</p>
            <div className="space-y-2">
              <div className="flex gap-2">
                <Image className="mb-[24px] rounded-full" src="/Checkmark.png" alt="" width={16} height={16}/>
